...
class LocalDeploymentStatus(rpc.Shape):
    """
    ...
    @classmethod
    def _model_name(cls):
        return 'aws.greengrass#LocalDeploymentStatus'
...
class GetLocalDeploymentStatusResponse(rpc.Shape):
    ...
    def __init__(self, *,
                 deployment: typing.Optional[LocalDeploymentStatus] = None):
        super().__init__()
        self.deployment = deployment  # type: typing.Optional[LocalDeploymentStatus]

    def set_deployment(self, deployment: LocalDeploymentStatus):
    ...
    def _from_payload(cls, payload):
        ...
        if 'deployment' in payload:
            new.deployment = LocalDeploymentStatus._from_payload(payload['deployment'])
        return new
