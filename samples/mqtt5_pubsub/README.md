...
python3 mqtt5_pubsub/mqtt5_pubsub.py --endpoint <endpoint> --cert <file> --key <file>
```
...
```sh
# For Windows: replace 'python3' with 'python' and '/' with '\'
python3 mqtt5_pubsub/mqtt5_pubsub.py --endpoint <endpoint> --cert <file> --key <file> --ca_file <file>
```
