...
python3 mqtt5_pkcs11_connect/mqtt5_pkcs11_connect.py --endpoint <endpoint> --cert <path to certificate> --pkcs11_lib <path to PKCS11 lib> --pin <user-pin> --token_label <token-label> --key_label <key-label>
```
...
```sh
# For Windows: replace 'python3' with 'python' and '/' with '\'
python3 mqtt5_pkcs11_connect/mqtt5_pkcs11_connect.py --endpoint <endpoint> --cert <path to certificate> --pkcs11_lib <path to PKCS11 lib> --pin <user-pin> --token_label <token-label> --key_label <key-label> --ca_file <path to root CA>
```
...
6. Now you can run the sample with the following:
    ...
    ```sh
    # For Windows: replace 'python3' with 'python' and '/' with '\'
    python3 mqtt5_pkcs11_connect/mqtt5_pkcs11_connect.py --endpoint <endpoint> --ca_file <path to root CA> --cert <path to certificate> --pkcs11_lib <path to PKCS11 lib> --pin <user-pin> --token_label <token-label> --key_label <key-label>
    ```
