...
python3 identity/fleet_provisioning.py --endpoint <endpoint> --cert <file> --key <file> --template_name <name> --template_parameters <parameters>
```
...
``` sh
# For Windows: replace 'python3' with 'python' and '/' with '\'
python3 identity/fleet_provisioning.py --endpoint <endpoint> --cert <file> --key <file> --template_name <name> --template_parameters <parameters> --ca_file <file>
```
...
``` sh
# For Windows: replace 'python3' with 'python' and '/' with '\'
python3 identity/fleet_provisioning.py --endpoint <endpoint> --cert <file> --key <file> --template_name <name> --template_parameters '{\"SerialNumber\":\"1\",\"DeviceLocation\":\"Seattle\"}'
```
...
``` sh
# For Windows: replace 'python3' with 'python' and '/' with '\'
python3 identity/fleet_provisioning.py --endpoint <endpoint> --cert <file> --key <file> --template_name <name> --template_parameters '{\"SerialNumber\":\"1\",\"DeviceLocation\":\"Seattle\"}' --csr <path to csr file>
```
