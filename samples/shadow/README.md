...
python3 shadow/shadow.py --endpoint <endpoint> --cert <file> --key <file> --thing_name <name>
```
...
``` sh
# For Windows: replace 'python3' with 'python' and '/' with '\'
python3 shadow/shadow.py --endpoint <endpoint> --cert <file> --key <file> --thing_name <name> --ca_file <file>
```
