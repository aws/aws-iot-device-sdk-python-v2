...
python3 basic_connect/basic_connect.py --endpoint <endpoint> --cert <file> --key <file>
```
...
```sh
# For Windows: replace 'python3' with 'python' and '/' with '\'
python3 basic_connect/basic_connect.py --endpoint <endpoint> --cert <file> --key <file> --ca_file <file>
```
